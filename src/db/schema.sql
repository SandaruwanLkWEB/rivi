...
-- A vehicle can be assigned to ONLY ONE route within the SAME request
CREATE UNIQUE INDEX IF NOT EXISTS uq_request_assignments_request_vehicle
  ON request_assignments (request_id, vehicle_id);
